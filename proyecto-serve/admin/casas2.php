                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <?php if (!empty($erroresId_comunidad)): ?>
                                    <div class="text-danger small mt-1"><?= $erroresId_comunidad ?></div>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
                                ...
                                <?php if (!empty($erroresNombre)): ?>
                                    <div class="text-danger small mt-1"><?= htmlspecialchars($erroresNombre) ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if (!empty($erroresId_provincia)): ?>
                                    <div class="text-danger small mt-1"><?= $erroresId_provincia ?></div>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-4">
                                ...
                                <?php if (!empty($erroresId_ciudad)): ?>
                                    <div class="text-danger small mt-1"><?= $erroresId_ciudad ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
