                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresUsername)): ?>
                            <div class="form-error"><?= $erroresUsername ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresNombre)): ?>
                            <div class="form-error"><?= $erroresNombre ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresApellidos)): ?>
                            <div class="form-error"><?= $erroresApellidos ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresEdad)): ?>
                            <div class="form-error"><?= $erroresEdad ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresEmail)): ?>
                            <div class="form-error"><?= $erroresEmail ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresTelefono)): ?>
                            <div class="form-error"><?= $erroresTelefono ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($erroresPasswordConfirm)): ?>
                            <div class="form-error"><?= $erroresPasswordConfirm ?></div>
                        <?php endif; ?>
                        <?php if (!empty($erroresCoincidencia)): ?>
                            <div class="form-error"><?= $erroresCoincidencia ?></div>
                        <?php endif; ?>
                    </div>
                </div>
