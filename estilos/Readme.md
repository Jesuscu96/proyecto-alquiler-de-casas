...
En casas mejorar la visualizacion del alert y no esta toda la informacion ⌛🟡

Cambiar todos lo iconos me quedan muy pocos 🟡 ⌛

Mirar la paginacion en Falta fontend  ⌛

Crear mas Usuarios y casas en bbdd 🟡 ⌛

Crear mas Usuarios y casas en bbdd 🟡 ⌛

Crear subidas de imagenes para ver en el carusel 🟡 ⌛

En casas mejorar la visualizacios del formulario a mas pequeño  ⌛

Mejorar la estetica general ya lo ✅ revisar pijotadas ⌛

En editar solo muestre provincia ✅ y en crear mostar los campos no vacios  si salta un error revisar ⌛

Asegurarme del guardado de las imagenes es correcto en casas.php✅

Mirar la paginacion en Falta bakend  ✅
