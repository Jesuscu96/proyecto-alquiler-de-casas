                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fecha_inicio" class="form-control" value="<?= htmlspecialchars($datos_reserva['fecha_inicio']) ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fecha_fin" class="form-control" value="<?= htmlspecialchars($datos_reserva['fecha_fin']) ?>">
