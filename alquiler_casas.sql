...
(17, 'propietario01', 'Rubén', 'Moreno', 44, 'ruben.prop1@mail.com', 'proppass1', 'cliente', '600333331'),
...
ALTER TABLE `imagenes`
  ADD CONSTRAINT `imagenes_ibfk_1` FOREIGN KEY (`id_casa`) REFERENCES `casas_vacacionales` (`id_casa`) ON DELETE RESTRICT ON UPDATE RESTRICT;
