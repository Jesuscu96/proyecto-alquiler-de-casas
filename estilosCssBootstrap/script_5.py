...
# Crear un archivo admin.php mejorado como dashboard principal
admin_dashboard = """<?php
...
print("✓ Archivo admin.php creado exitosamente")
print("\n" + "="*60)
print("RESUMEN DE ARCHIVOS CREADOS:")
print("="*60)
print("1. admin.php - Dashboard principal del administrador")
print("2. gestion-usuarios.php - Gestión completa de usuarios")
print("3. gestion-casas.php - Gestión completa de casas")
print("4. gestion-reservas.php - Gestión completa de reservas")
print("="*60)
print("\nTodos los archivos usan:")
print("- Bootstrap 5.3.2")
print("- styles.css (mismo estilo que indexCasa.php)")
print("- Navbar y hero con diseño consistente")
print("- Tablas, modales y formularios funcionales")
