...
# Crear el archivo gestion-reservas.php
...
# Guardar el archivo
with open('gestion-reservas.php', 'w', encoding='utf-8') as f:
    f.write(gestion_reservas)

print("✓ Archivo gestion-reservas.php creado exitosamente")
